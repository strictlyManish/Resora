...
function Profile() {
  ...
  // ✅ FIX: ensure no empty string goes to src
  const profileImage =
      ...
      <main className="px-6 flex-1">
          ...
          <div className="relative group">
            <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 p-[3px] shadow-lg">
              ...
              {profileImage ? (
                ...
                // ✅ fallback avatar (no src issue)
                <div className="w-full h-full flex items-center justify-center rounded-full bg-[#1a141a] text-gray-400 text-sm">
                  No Image
                </div>
              )}
        ...
        <section className="grid grid-cols-7 gap-2 mt-6">
          <button
            ...
            className="col-span-3 bg-pink-600 hover:bg-pink-700 active:scale-95 transition-all font-semibold py-2.5 rounded-xl"
          >
            Edit
          </button>
          ...
          <button
            ...
            className="col-span-1 flex items-center justify-center bg-white/10 hover:bg-white/20 rounded-xl transition-all"
          >
            <LogOut size={18} />
          </button>
        </section>
        ...
        <nav className="mt-10 border-t border-white/10">
          <div className="flex justify-around py-4">
            ...
            <UserRoundPen className="text-gray-500 hover:text-white cursor-pointer" />
            <BoomBox className="text-gray-500 hover:text-white cursor-pointer" />
          </div>
          ...
          <div className="py-8">
            {user?.posts?.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-10">
                <Music size={48} strokeWidth={1} className="opacity-40" />
                <p className="mt-2 font-medium opacity-40">
                  No posts yet
                </p>
                <button className="bg-gray-600 mt-8 px-6 py-2 rounded-full">
                  Make a Post
                </button>
              </div>
            )}
